...
// randomly select color from the above list.
...
// generate squares with random color 

while(i<numberOfSquares){
    const square = document.createElement('li');
    const color = selectColor();
    // square.style.background = color;
    square.setAttribute("data-color", color);       // to hide color
...
function isMatch() {
    ...
    square1.classList.add("pop");           // for animation
